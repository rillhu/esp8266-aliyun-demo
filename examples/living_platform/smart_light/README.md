...
- [x] Based on  ESP8266_RTOS_SDK v3.2

  `git clone -b v3.2 https://gitee.com/xuhongv/ESP8266_RTOS_SDK.git`

- [x] Based on esp-aliyun commit:`f5438e1541926133a77023ea8e37227e5259a183`

  `git clone https://gitee.com/xuhongv/esp-aliyun.git`

- [x] Build and Flash

  - place `smart_light` into `esp-aliyun\examples\solutions`

  - use the updated [mysys32](https://cloud.189.cn/t/AZnm2mBJRbEb)(based on esp32 but replace the elf files and esp32_toolchain.sh)

  - export IDF_PATH=" ESP8266_RTOS_SDK"

  - then follow the instruction as below items.

    ```
    make chip=esp8266 defconfig -j8 && make menuconfig -j8
    make -j8 flash monitor
    ```
    
- please be aware that flash quard key into NVS flash is a little different with esp32
  
- [x] Code
  - use GPIO 15 to control the light bulb on/off
  - use on board led(GPIO 16) flash every 2 seconds to show work state(wifi is connected)

- [x] running state show

<iframe height=272 width=360 src="https://rillhudev.coding.net/p/blogres/d/blogres/git/raw/master/esp8266-smartlight-aliyun.gif">
